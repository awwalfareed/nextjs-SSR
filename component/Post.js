        ...
        <div className={styles.celeb}>
            <div className={styles.divde}>
                <div className={styles.bg}>
                    <Image src={Celeb} alt="Celebrity" className={styles.cel} height="70px" width="70px" />
                </div>
                <h5 className={styles.title}>CELEBRITY</h5>
            </div>
            <div className={styles.divde}>
                <div className={styles.bg}>
                    <Image src={Kpop} alt="Celebrity" className={styles.cel} height="70px" width="70px" />
                </div>
                <h5 className={styles.title}>K-POP</h5>
            </div>
            <div className={styles.divde}>
                <div className={styles.bg}>
                    <Image src={Meme} alt="Celebrity" className={styles.cel} height="70px" width="70px" />
                </div>
                <h5 className={styles.title}>MEMES</h5>
            </div>
            <div className={styles.divde}>
                <div className={styles.bg}>
                    <Image src={Singer} alt="Celebrity" className={styles.cel} height="70px" width="70px" />
                </div>
                <h5 className={styles.title}>SINGER</h5>
            </div>
            <div className={styles.divde}>
                <div className={styles.bg}>
                    <Image src={Athlete} alt="Celebrity" className={styles.cel} height="70px" width="70px" />
                </div>
                <h5 className={styles.title}>ATHELETES </h5>
            </div>
            <div className={styles.divde}>
                <div className={styles.bg}>
                    <Image src={Ipl} alt="Celebrity" className={styles.cel} height="70px" width="70px" />
                </div>
                <h5 className={styles.title}>IPL</h5>
            </div>
            <div className={styles.divde}>
                <div className={styles.bg}>
                    <Image src={Holly} alt="Celebrity" className={styles.cel} height="70px" width="70px" />
                </div>
                <h5 className={styles.title}>HOLLYWOOD</h5>
            </div>
            <div className={styles.divde}>
                <div className={styles.bg}>
                    <Image src={Buss} alt="Celebrity" className={styles.cel} height="70px" width="70px" />
                </div>
