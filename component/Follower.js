...
// ?import InstaBussiness from '../pages/InstaBussiness'
...
export default function Follower(props) {
    ...
    const options = {
        method: 'GET',
        url: `https://graph.facebook.com/v11.0/17841406993638186?fields=business_discovery.username(https.viren){followers_count,follows_count,media_count,media{comments_count,like_count},username,name,biography}&access_token=${props.accesstoken}`,
    };
